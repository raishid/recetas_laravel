...
@section('content')
    ...
    <h2 class="text-center my-5">Receta Creadas por: {{ $perfil->user->name  }}</h2>
    <div class="container">
                ...
                @foreach ($recetas as $receta)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3>{{ $receta->titulo }}</h3>
                                <a href="{{ route('recetas.show', $receta->id) }}" class="btn btn-primary d-block mt-4 text-uppercase font-weigth-bold">Ver Receta</a>
                            </div>
